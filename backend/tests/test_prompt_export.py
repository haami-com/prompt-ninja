...
def test_export_declares_placeholders_from_the_generated_prompt(tmp_path):
    content = export_prompt_toml(PromptExportRequest(
...
def test_export_serializes_a_supplied_prompt_ninja_definition_without_losing_its_schema_or_tests(tmp_path):
